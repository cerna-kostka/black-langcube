...
class SimpleWorkflow(BaseGraph):
    ...
    def build_graph(self):
        ...
        def step_2_enhance_output(state):
            ...
            return {"processed_output": enhanced, "step_count": state["step_count"]}
        ...
        def step_3_finalize(state):
            ...
            return {"processed_output": final, "step_count": state["step_count"]}
...
async def main():
    ...
    workflow = SimpleWorkflow(
        user_message=user_message, folder_name=str(output_dir), language="English"
    )
